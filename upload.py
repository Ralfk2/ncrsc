...
class Menu(object):
    def __init__(self, nc_window, rs_rpc, parser, parent):
        #menu - structure
        self.title = "Uploads"
        self.cur_funct = self.print_active_uploads
    ...
    def print_active_uploads(self):
        ...
        if transfers:
            ...
            for transfer in transfers:
                ...
                i+=1
            self.__nc_window.addstr(1, 1, "active Uploads ("+str(i)+"):")
        else:
            self.__nc_window.addstr(1, 1, "no active Uploads")
